...
from franka_bringup.launch_validation import validate_arm_ids
...
def _launch_setup(context):
    ...
    validate_arm_ids({
        arm_id_1_parameter_name: arm_id_1.perform(context),
        arm_id_2_parameter_name: arm_id_2.perform(context),
    })
    ...
    return [
        ...
        Node(
            ...
            executable='franka_joint_state_publisher',
        ...
        Node(
            package='controller_manager',
            executable='spawner',
            arguments=['franka_panda1_robot_state_broadcaster', '--switch-asap'],
            output='screen',
        ...
        Node(
            package='controller_manager',
            executable='spawner',
            arguments=['franka_panda2_robot_state_broadcaster', '--switch-asap'],
            output='screen',
            condition=UnlessCondition(use_fake_hardware),
        ),
        Node(
            package='controller_manager',
            executable='spawner',
            arguments=['franka_panda1_robot_model_broadcaster', '--switch-asap'],
            output='screen',
            condition=UnlessCondition(use_fake_hardware),
        ),
        Node(
            package='controller_manager',
            executable='spawner',
            arguments=['franka_panda2_robot_model_broadcaster', '--switch-asap'],
            output='screen',
            condition=UnlessCondition(use_fake_hardware),
        ),
