...
def generate_launch_description():
    ...
    # This must match the namespace argument under mujoco_ros2_control in the plugin's
    # parameter yaml file. See ros2_control_plugins_example_with_ns.yaml for details.
    ns = ''
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            ...
            description='Initial joint positions of the robot. Must be enclosed in quotes, '
                        'and in pure number.'
