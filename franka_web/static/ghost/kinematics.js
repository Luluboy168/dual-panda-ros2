...
/**
 * Invert a rigid (rotation + translation) row-major 4x4.
 *
 * For R|t the inverse is R^T | -R^T t. This is NOT a general inverse and
 * must not be used on anything with scale or shear; every matrix
 * forwardKinematics() produces is rigid.
 */
